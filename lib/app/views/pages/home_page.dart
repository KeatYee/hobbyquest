            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() {
                    final nextLevel = controller.level.value + 1;
                    final message = "Keep it up ${controller.nickname.value}! 🔥 You're crushing it in ${controller.selectedHobby.value}! Complete 1 more quest to hit Level $nextLevel.";
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      // Reroll Button
                      TextButton.icon(
                        onPressed: () => controller.rerollDailyQuests(),
                  ...
                  Obx(() => Column(
                    children: controller.dailyQuests.map((quest) {
                      return _buildQuestCard(
                        ...
                        onTap: () => controller.startQuest(quest['id']),
                      );
                    }).toList(),
                  )),
            ...
            children: [
              Container(
                ...
                child: const CircleAvatar(
                  radius: 28,
                  // Use a local asset or a safe fallback to prevent crashes
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // REACTIVE XP TEXT
                Obx(() => Text(
                  "${controller.currentXp.value} / ${controller.requiredXp.value} XP to Level ${controller.level.value + 1}",
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    color: AppColors.textSecondary
                  ),
                )),
